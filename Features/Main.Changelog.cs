...
public partial class Main
{
    ...
    [
        new(2026, 07, 31, 1,
            ...
            "Vicious Hound is no longer enabled by default.",
            "Applying Bestiary Regex should now be more reliable and no longer retries when the filter was already applied correctly."),
        new(2026, 07, 30, 1,
            "Counter Window -> Tracked Completion Message now also finishes maps where none of your enabled beasts spawned, instead of never completing."),
        new(2026, 07, 29, 1,
            "Maps run with a Bestiary Scarab of Duplicating now count captured beasts twice, so captured totals and value match what you actually get.",
            "Analytics Web Server -> Map History beast breakdown now shows which beasts were duplicated and whether Dup Scarab was used.",
            "Mirrored beasts no longer show up on labels, map markers, or the tracked beasts window.",
            "Tracked beasts now disappear from map overlays once the completion message is shown.",
            "Two separate runs of the same map are no longer merged into one entry."),
        new(2026, 07, 28, 1,
            "Beast quest progress and the completion message work again after the recent game update.",
            "Mirrored beasts are no longer counted as red beasts and no longer keep a map from completing.",
            "Completion tracking now remembers beasts for the whole map, so beasts that disappear still count.",
            "Added Farric Frost Hellion Alpha to the tracked beast list.",
            "Renamed Craicic Chimeral to Craicic Croaker to match the current in-game name."),
        new(2026, 07, 27, 2,
            "Added Tracking: Price Data -> Auto Sync League, which fills in your current league automatically so prices load without editing the League field.",
            "Default league is now Allflame."),
        new(2026, 07, 27, 1,
            "Fixes for 3.29: map stash restock finds your maps again, and automation no longer crashes while pathing in hideout."),
        new(2026, 04, 24, 2,
